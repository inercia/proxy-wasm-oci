...
func WithInsecureSkipTLSVerify(b bool) Option {
	return func(p *options) {
		p.Insecure = b
	}
}
...
type Pusher interface {
	...
	Push(wasmExe, metadataFile, url string, options ...Option) error
}
...
func All(settings *config.GlobalSettings) Providers {
